...
void app_main(void) {
    ...
    /* for (int n=0; n<MATRIX_COUNT; n++) bytes[n] = n+1; */

    /* max7219_sendBytesInTransaction(spi, 1, bytes); */
    max7219_sendText(spi, "SALAMANC");
    ...
    /* max7219_sendText(spi, "0123456789ABCDEFGHIJ"); */
